...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x0002);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RAM_POWERDOWN_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MSD_ZIGBEE_52840, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_APPROTECT_LOCK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_CDC_ACM_RINGBUF_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUS_CMD_LOG_LEVEL_INF, 1);
